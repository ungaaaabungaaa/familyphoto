...
public class eyeupload extends AppCompatActivity implements BSImagePicker.OnSingleImageSelectedListener,  BSImagePicker.ImageLoaderDelegate,BSImagePicker.OnSelectImageCancelledListener{
    ...
    // starts bottom screen galler to pick image
    ...
    // upload the image to firbase database compressed, cropped
            ...
            mUploadTask = fileReference.putFile(compreeseduri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Intent intent = new Intent(eyeupload.this, MainActivity.class);
    ...
    // load the images into bottom screen gallery
    ...
    // after image is selected croping starts
    @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
              ...
              // compressing the cropped image to reduce upload size
